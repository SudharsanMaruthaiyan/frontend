  ...
  return (
    <div className=' flex bg-primary rounded-lg  px-6 sm:px-10 lg:px-12 my-20 md:mx-10 '>
        ...
        <div className=' flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
            ...
            <button onClick={()=>navigate('/login')} className=' bg-white text-sm sm:text-base text-gray-600 px-8 py-3 rounded-full mt-6 hover:scale-105 transition-all'>Creat account</button>
        </div>
        {/* Right side  */}
